...
#	up
set_property PACKAGE_PIN T18 [get_ports {direction[0]}] 						
...
#	right
set_property PACKAGE_PIN T17 [get_ports {direction[2]						
	set_property IOSTANDARD LVCMOS33 [get_ports {direction[2]}]
#	down
set_property PACKAGE_PIN U17 [get_ports {direction[3]}]						
